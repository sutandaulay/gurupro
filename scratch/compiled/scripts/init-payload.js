...
async function initPayload() {
    ...
    try {
        ...
        try {
            ...
            console.log("⚠️ Could not create features:", err.message);
        }
        ...
        try {
            ...
            console.log("⚠️ Could not create why points:", err.message);
        }
        ...
        try {
            ...
            console.log("⚠️ Could not create landing page:", err.message);
        }
        ...
        try {
            ...
            console.log("⚠️ Could not create footer:", err.message);
        }
        ...
        try {
            ...
            console.log("⚠️ Could not create chatbot config:", err.message);
        }
