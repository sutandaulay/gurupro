...
CREATE TABLE "landing_page_settings" (
    ...
    "footer_desc" TEXT,
    "footer_terms" VARCHAR(500),
    "footer_privacy" VARCHAR(500),
    "footer_contact" VARCHAR(255),
    "min_payout_cashback" INTEGER DEFAULT 50000,
    "cashback_to_token_rate" INTEGER DEFAULT 1000,
    "created_at" TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "TokenUsage" (
    ...
    "total_cost_idr" DOUBLE PRECISION NOT NULL,
    "mapel" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "GeminiCache_cache_name_key" ON "GeminiCache"("cache_name");

-- CreateIndex
CREATE UNIQUE INDEX "TokenUsage_request_id_key" ON "TokenUsage"("request_id");
