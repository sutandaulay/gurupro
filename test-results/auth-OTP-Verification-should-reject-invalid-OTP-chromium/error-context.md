...
- Name: auth.spec.ts >> OTP Verification >> should reject invalid OTP
- Location: tests\e2e\auth.spec.ts:112:7
...
Call log:
  - waiting for locator('input[maxlength="6"]')
    ...
    - generic [ref=e52]:
      ...
      - generic [ref=e60]:
        ...
        - generic [ref=e65]:
          ...
          - generic [ref=e67]:
            - img
            - textbox "nama@email.com" [ref=e68]: otp_1785675942071@test.gurupro.id
        - generic [ref=e69]:
