...
- Name: auth.spec.ts >> Role-Based Access Control >> should show user dropdown with logged-in identity
- Location: tests\e2e\auth.spec.ts:203:7
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - generic [ref=e48]:
      ...
      - generic [ref=e52]:
        - img [ref=e53]
        - paragraph [ref=e55]: Akun Anda terkunci sementara karena terlalu banyak kegagalan login. Silakan coba lagi dalam 10 menit.
      - generic [ref=e56]:
        - generic [ref=e57]:
