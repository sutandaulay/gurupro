-- migrations/02_add_institutions_and_members.sql
-- UP
...
-- DOWN
-- To rollback, you can run the following drop statements:
-- DROP TABLE IF EXISTS "chatbot_config" CASCADE;
-- DROP TABLE IF EXISTS "footer_content_social_links" CASCADE;
-- DROP TABLE IF EXISTS "footer_content_links" CASCADE;
-- DROP TABLE IF EXISTS "footer_content" CASCADE;
-- DROP TABLE IF EXISTS "landing_page_hero_stats" CASCADE;
...
-- DROP TABLE IF EXISTS "cms_users_sessions" CASCADE;
