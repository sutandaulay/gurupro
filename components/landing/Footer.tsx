      ...
      <div className="border-t border-neutral-800">
        <div className="container-page py-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-neutral-600">
          ...
          <div className="flex items-center gap-4">
            <a href="/kebijakan-privasi" className="text-neutral-500 hover:text-white transition">Kebijakan Privasi</a>
            <a href="/syarat-ketentuan" className="text-neutral-500 hover:text-white transition">Syarat & Ketentuan</a>
            <a href="/refund" className="text-neutral-500 hover:text-white transition">Kebijakan Refund</a>
            {madeInIndonesia && (
              <span className="inline-flex items-center gap-1.5 text-neutral-500 ml-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
                </svg>
                Ekosistem Dari VideaClass
              </span>
            )}
          </div>
        </div>
