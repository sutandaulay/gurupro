...
const routes: RouteEntry[] = [
  ...
  { pattern: ["institution", ":institutionId", "operator"], component: dynamic(() => import("../institution/[institutionId]/operator/content")), paramKeys: ["institutionId"] },
  { pattern: ["institution", ":institutionId", "laporan-mengajar"], component: dynamic(() => import("../institution/[institutionId]/laporan-mengajar/content")), paramKeys: ["institutionId"] },
  { pattern: ["institution", ":institutionId", "laporan-mengajar", ":id"], component: dynamic(() => import("../institution/[institutionId]/laporan-mengajar/[id]/content")), paramKeys: ["institutionId", "id"] },
