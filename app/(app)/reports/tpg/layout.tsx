...
export default async function TPGReportLayout({
  children,
}: {
  ...
  // Hanya pengguna dengan peran tertentu yang bisa mengakses laporan TPG
  // Guru bisa melihat laporan TPG miliknya sendiri
  // Kepala Sekolah/Wakasek/Operator bisa melihat laporan TPG di institusinya
